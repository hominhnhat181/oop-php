...
// new class(not file)
 $pd = new product();
//  nếu dùng phương thức post và nhấn vào submit thì mới thêm
 if($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])){
    // co $_FILES vì có hình ảnh
    // $_Post nghĩa là láy tất cả dữ liệu khi nhấn submit được gửi về hàm insert_product
